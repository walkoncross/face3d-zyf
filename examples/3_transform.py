...
options = (
    "-delay 10 -loop 0 -layers optimize"  # gif options. need ImageMagick installed.
)
...
subprocess.call(
    "convert {} {}/1_*.jpg {}".format(options, save_folder, save_folder + "/obj.gif"),
    shell=True,
)
...
subprocess.call(
    "convert {} {}/2_*.jpg {}".format(
        options, save_folder, save_folder + "/camera.gif"
    ),
    shell=True,
)
