...
def light_test(vertices, light_positions, light_intensities, h=256, w=256):
    lit_colors = mesh.light.add_light(
        vertices, triangles, colors, light_positions, light_intensities
    )
...
subprocess.call(
    "convert {} {}/1_*.jpg {}".format(
        options, save_folder, save_folder + "/position.gif"
    ),
    shell=True,
)
...
subprocess.call(
    "convert {} {}/2_*.jpg {}".format(
        options, save_folder, save_folder + "/intensity.gif"
    ),
    shell=True,
)
