...
io.imsave('{}/color.jpg'.format(save_folder), img_as_ubyte(np.squeeze(color_image)))
...
io.imsave('{}/depth.jpg'.format(save_folder), img_as_ubyte(np.squeeze(depth_image)))
...
io.imsave('{}/pncc.jpg'.format(save_folder), img_as_ubyte(np.squeeze(pncc_image)))
...
io.imsave('{}/uv_coords.jpg'.format(save_folder), img_as_ubyte(np.squeeze(uv_coords_image)))
